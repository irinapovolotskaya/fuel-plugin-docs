...
project = u'Test Report for NAME plugin for Fuel'
...
latex_documents = [
  ('index', 'name.tex', u'NAME plugin for Fuel Documentation',
...
texinfo_documents = [
  ('index', 'NAME', u'NAME Plugin for Fuel Documentation',
   u'COMPANY.', 'NAME', 'NAME Plugin for Fuel Documentation',
   'Miscellaneous'),
]
